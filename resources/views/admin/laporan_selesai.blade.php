...
<div class="container dashboard-container">
    <div class="welcome-section">
        <h1 class="welcome-title">Laporan Selesai (Admin) 👑</h1>
        <p class="welcome-subtitle mb-0">Daftar laporan barang hilang atau temuan yang telah sukses diselesaikan/dikembalikan oleh sistem.</p>
    </div>
