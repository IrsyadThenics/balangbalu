        ...
        <div class="tab-pane fade" id="claims-pane" role="tabpanel" aria-labelledby="claims-tab" tabindex="0">
            <div class="history-list">
                ...
                <div class="history-card d-flex flex-column align-items-stretch gap-3">
                    <div class="d-flex align-items-center gap-3 w-100">
                        ...
                        <div class="history-content">
                            ...
                            <div class="history-meta">
                                ...
                                @if($claim->no_wa)
                                <span class="meta-item"><i data-lucide="phone" style="width: 14px;"></i> WA: {{ $claim->no_wa }}</span>
                                @endif
                            </div>
                        </div>
                        <div>
                    ...
                    @if($claim->status == 'pending')
                    <div class="p-3 rounded-4 border border-opacity-10" style="background-color: #f0fdf4 !important; border-color: #bbf7d0 !important; font-size: 0.85rem; margin-top: 0.25rem;">
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            <div class="d-flex align-items-center gap-2">
                                <i data-lucide="help-circle" class="text-success" style="width: 16px;"></i>
                                <span class="text-muted">Ingin mempercepat proses verifikasi? Anda bisa langsung menghubungi Admin.</span>
                            </div>
                            <a href="https://wa.me/6281234567890?text=Halo%20Admin,%20saya%20ingin%20mengonfirmasi%20pengajuan%20untuk%20{{ urlencode($claim->report->nama_laporan) }}." target="_blank" class="btn btn-success btn-sm rounded-pill fw-bold px-3 py-1 d-inline-flex align-items-center gap-1" style="background-color: #22c55e; border: none; font-size: 0.75rem;">
                                <i data-lucide="message-circle" style="width: 12px;"></i> Chat Admin
                            </a>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="mt-2 p-2 bg-white rounded-3 border" style="max-width: fit-content;">
                        <span class="text-muted small fw-bold d-block mb-1" style="font-size: 0.7rem; text-transform: uppercase;">Gambar Bukti Terlampir:</span>
                        <a href="{{ asset('storage/claims/'.$claim->bukti_gambar) }}" target="_blank">
                            <img src="{{ asset('storage/claims/'.$claim->bukti_gambar) }}" class="rounded-2 shadow-sm" style="max-height: 80px; width: auto; object-fit: cover;">
                        </a>
                    </div>
                    @endif
